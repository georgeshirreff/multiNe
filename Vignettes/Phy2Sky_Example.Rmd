...
```{r}
Phy2Sky(trees,output_type="matrices")
```
...
```{r}
Phy2Sky(trees,output_type = "master")
```
...
Phy2Sky(trees,output_type = "conf.int.plot",fixToDate = T,Date_FUN = Date_FUN)
```
